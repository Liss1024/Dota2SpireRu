 ...
 * 不会复制状态牌或诅咒牌
 */
public class MantaStyle extends CustomRelic {
    // ID, images, text.
    ...
    public void onUseCard(AbstractCard card, UseCardAction useCardAction) {
        if (this.counter <= 0 && card.exhaust && card.type != AbstractCard.CardType.CURSE && card.type != AbstractCard.CardType.STATUS) {
            flash();
